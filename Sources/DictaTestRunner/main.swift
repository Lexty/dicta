...
// command is worthless as a gate (D18). The real run goes through swift-testing's own entry point
// here and exits non-zero on failure. Run it with `bash Scripts/test.sh`.
